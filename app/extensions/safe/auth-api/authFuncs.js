...
export const setNetworkListener = cb => authenticator.setListener( CONSTANTS.LISTENER_TYPES.NW_STATE_CHANGE, cb );

export const setAppListUpdateListener = cb => authenticator.setListener( CONSTANTS.LISTENER_TYPES.APP_LIST_UPDATE, cb );

export const setIsAuthorisedListener = cb => authenticator.setListener( CONSTANTS.LISTENER_TYPES.IS_AUTHORISED, cb );
...
export const createAccount = ( secret, password, invitation ) => authenticator.createAccount( secret, password, invitation );

export const getAuthorisedApps = () => authenticator.getRegisteredApps();

export const getAccountInfo = () => authenticator.getAccountInfo();

export const authDecision = ( authData, isAllowed ) => authenticator.encodeAuthResp( authData, isAllowed );

export const revokeApp = appId => authenticator.revokeApp( appId );

export const containerDecision = ( contData, isAllowed ) => authenticator.encodeContainersResp( contData, isAllowed );
