...
export const setupPreloadedSafeAuthApis = passedStore =>
{
    ...
    window.safeAuthenticator.getNetworkState = ( ) =>
    {
        ...
        logger.log( 'getting the network state!', state.authenticator.networkState );
    ...
    {
        const state = passedStore.getState();
        logger.log( 'window method for get auth handle being called', state.authenticator.authenticatorHandle );
